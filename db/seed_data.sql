...
-- 演示审计事件严格遵循 created -> booked -> seated -> dining -> finished 状态机：
-- 完成态预约体现完整三步流转（booked->seated->dining->finished），不再出现 seated->finished 捷径。
INSERT IGNORE INTO reservation_events (reservation_id, from_status, to_status, actor_role, actor_user_id, note) VALUES
(3, 'booked', 'seated', 'staff', 2, '顾客已入座'),
(3, 'seated', 'dining', 'staff', 2, '开始用餐'),
(3, 'dining', 'finished', 'staff', 2, '用餐完成'),
(4, 'booked', 'seated', 'staff', 2, '顾客已入座'),
(4, 'seated', 'dining', 'staff', 2, '开始用餐'),
(4, 'dining', 'finished', 'staff', 2, '用餐完成'),
(5, 'booked', 'seated', 'staff', 2, '顾客已入座'),
(8, 'booked', 'seated', 'staff', 2, '顾客已入座'),
(8, 'seated', 'dining', 'staff', 2, '开始用餐'),
(8, 'dining', 'finished', 'staff', 2, '用餐完成'),
(9, 'booked', 'seated', 'staff', 2, '顾客已入座'),
(9, 'seated', 'dining', 'staff', 2, '开始用餐'),
(9, 'dining', 'finished', 'staff', 2, '用餐完成'),
(10, 'booked', 'seated', 'staff', 2, '顾客已入座'),
(10, 'seated', 'dining', 'staff', 2, '开始用餐'),
(10, 'dining', 'finished', 'staff', 2, '用餐完成'),
(11, 'booked', 'seated', 'staff', 2, '顾客已入座'),
(11, 'seated', 'dining', 'staff', 2, '开始用餐'),
(11, 'dining', 'finished', 'staff', 2, '用餐完成'),
(12, 'booked', 'cancelled', 'customer', 5, '顾客取消预约'),
(13, 'booked', 'seated', 'staff', 2, '顾客已入座'),
(13, 'seated', 'dining', 'staff', 2, '开始用餐'),
(13, 'dining', 'finished', 'staff', 2, '用餐完成'),
(14, 'booked', 'no_show', 'staff', 2, '标记未到店'),
(15, 'booked', 'seated', 'staff', 2, '顾客已入座'),
(15, 'seated', 'dining', 'staff', 2, '开始用餐'),
(15, 'dining', 'finished', 'staff', 2, '用餐完成'),
(16, 'booked', 'seated', 'staff', 2, '顾客已入座'),
(16, 'seated', 'dining', 'staff', 2, '开始用餐'),
(16, 'dining', 'finished', 'staff', 2, '用餐完成'),
(17, 'booked', 'seated', 'staff', 2, '顾客已入座'),
(17, 'seated', 'dining', 'staff', 2, '开始用餐'),
(17, 'dining', 'finished', 'staff', 2, '用餐完成');
